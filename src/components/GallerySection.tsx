...
export default function GallerySection() {
    ...
    return <section className="h-[746px] px-5 md:px-0 md:h-[832px] gallery-sec-bg relative flex items-center justify-center overflow-hidden">
        <Image onMouseOver={() => previewImage(PrevImage1)} onMouseLeave={() => setOpenModal(false)} src={GalImage1} alt="gallery-img-1" width={329} height={163.88} className="absolute rounded-[5.84px] md:rounded-[10px] top-[90.05px] -left-7 md:left-[161px] md:top-[78px] w-[176.67px] md:w-auto h-[88px] md:h-auto" />
        <Image onMouseOver={() => previewImage(PrevImage2)} onMouseLeave={() => setOpenModal(false)} src={GalImage2} alt="gallery-img-2" width={206} height={102.61} className="absolute rounded-[5.84px] md:rounded-[10px] top-[195.21px] md:top-[125px] right-[90px] md:right-[388px] w-[96.36px] md:w-auto h-12 md:h-auto" />
        ...
        <Image onMouseOver={() => previewImage(PrevImage4)} onMouseLeave={() => setOpenModal(false)} src={GalImage4} alt="gallery-img-4" width={170} height={119} className="absolute rounded-[10px] md:top-[364px] md:-left-[19px] -left-3 bottom-[238px] w-[97.14px] md:w-auto h-[68px] md:h-auto" />
        <Image onMouseOver={() => previewImage(PrevImage5)} onMouseLeave={() => setOpenModal(false)} src={GalImage5} alt="gallery-img-5" width={250} height={175.53} className="absolute rounded-[10px] md:top-[363px] bottom-[196px] -right-1 w-[113.94px] md:w-auto h-20 md:h-auto" />
        <Image onMouseOver={() => previewImage(PrevImage6)} onMouseLeave={() => setOpenModal(false)} src={GalImage6} alt="gallery-img-6" width={250} height={175.53} className="absolute rounded-[10px] md:bottom-[104.47px] bottom-[24.72px] -left-5 md:left-[271px] w-[142.42px] md:w-auto h-[100px] md:h-auto" />
        <Image onMouseOver={() => previewImage(PrevImage7)} onMouseLeave={() => setOpenModal(false)} src={GalImage7} alt="gallery-img-7" width={170} height={119} className="absolute rounded-[10px] bottom-[114.01px] md:bottom-[163px] md:right-[388px] right-1/2 w-[102.86px] md:w-auto h-[72px] md:h-auto translate-x-1/2" />
